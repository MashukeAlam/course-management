...
class StudentSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_subject" do
    assert_difference('StudentSubject.count') do
      post student_subjects_url, params: { student_subject: { subject_id: @student_subject.subject_id, user_id: @student_subject.user_id } }
    end
  ...
  test "should update student_subject" do
    patch student_subject_url(@student_subject), params: { student_subject: { subject_id: @student_subject.subject_id, user_id: @student_subject.user_id } }
