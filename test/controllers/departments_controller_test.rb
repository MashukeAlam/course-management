...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { desc: @department.desc, title: @department.title } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { desc: @department.desc, title: @department.title } }
