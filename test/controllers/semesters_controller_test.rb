...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { title: @semester.title, year_id: @semester.year_id } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { title: @semester.title, year_id: @semester.year_id } }
