...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { role: @request.role, user_id: @request.user_id } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { role: @request.role, user_id: @request.user_id } }
