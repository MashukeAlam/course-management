...
class StudentProgessesTest < ApplicationSystemTestCase
  ...
  test "creating a Student progess" do
    ...
    fill_in "Semester", with: @student_progess.semester_id
    fill_in "Student", with: @student_progess.student_id
    fill_in "Subject", with: @student_progess.subject_id
    fill_in "Year", with: @student_progess.year_id
